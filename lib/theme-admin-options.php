...
<div class="postbox metabox-holder">
  ...
  <h3 class="hndle"><?php _e( 'Purchase', 'emanon' ); ?></h3>
    <div class="inside">
    <ul>
...
function setting_manual () {
 add_theme_page( __( 'Emanon manual', 'emanon' ), __( 'Emanon manual', 'emanon' ), 'manage_options', 'emanon_manual', 'setting_manual_page');
}

add_action ( 'admin_menu', 'setting_manual' );
