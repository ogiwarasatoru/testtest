...
.side-widget-title span,.entry-header span,.archive-title h1 > span{border-bottom:1px solid <?php echo $main_color; ?>;}
.wpp-list li:before{background-color:<?php echo $main_color;?>;}
/*--link color--*/
#gnav .global-nav .current-menu-item > a,#modal-global-nav-container .current-menu-item a,#modal-global-nav-container .sub-menu .current-menu-item a,.side-widget .current-menu-item a,.mb-scroll-nav-inner .current-menu-item a,.entry-title a:active,.pagination a,.post-nav .fa{color:<?php echo $link_color; ?>;}
...
/*--h2-*/
.article-body h2 {border-left: 4px solid <?php echo $main_color;?>;}
/*--h3-*/
.article-body h3 {border-bottom: 2px solid <?php echo $main_color;?>;}
<?php if ( $header_description_background_color == '#f8f8f8' ): ?>
.top-bar{background-color:<?php echo $header_description_background_color; ?>;}
<?php else: ?>
.top-bar{background-color:<?php echo $header_description_background_color; ?>;border-bottom:1px solid <?php echo $header_description_background_color; ?>;}
<?php endif; ?>
